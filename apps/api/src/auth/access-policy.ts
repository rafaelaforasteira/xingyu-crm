...
export type Permission = "profile.view"|"profile.edit"|"settings.view"|"organization.manage"|"users.manage"|"teams.manage"|"permissions.view"|"dashboard.view"|"clients.view"|"pipelines.view"|"deals.edit"|"orders.view"|"orders.edit"|"finance.view"|"finance.sensitive"|"integrations.manage"|"automations.manage"|"automations.view";
...
const matrix: Record<AuthRole, { permissions: ReadonlySet<Permission>; scopes: Partial<Record<"deals"|"orders", AccessScope>> }> = {
  ADMIN: { permissions: new Set(["profile.view","profile.edit","settings.view","organization.manage","users.manage","teams.manage","permissions.view","dashboard.view","clients.view","pipelines.view","deals.edit","orders.view","orders.edit","finance.view","finance.sensitive","integrations.manage","automations.manage","automations.view"]), scopes: { deals:"ALL", orders:"ALL" } },
  MANAGER: { permissions: new Set(["profile.view","profile.edit","settings.view","pipelines.view","deals.edit","orders.view","orders.edit","automations.view","automations.manage"]), scopes: { deals:"ALL", orders:"ALL" } },
